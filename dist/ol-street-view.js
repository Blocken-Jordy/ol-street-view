...
(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define(['ol/Feature.js', 'ol/Collection.js', 'ol/style/Icon.js', 'ol/style/Style.js', 'ol/source/Vector.js', 'ol/source/XYZ.js', 'ol/geom/Point.js', 'ol/control/Control.js', 'ol/proj.js', 'ol/layer/Vector.js', 'ol/layer/Tile.js', 'ol/interaction/Translate.js', 'ol/Observable.js', 'interactjs'], factory) :
...
})(this, (function (Feature, Collection, Icon, Style, VectorSource, XYZ, Point, Control, proj_js, VectorLayer, TileLayer, Translate, Observable_js, interact) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    class StreetView extends Control {
        ...
        setMap(map) {
            ...
            if (map) {
                ...
                if (this._viewResolutionEventKey) {
                    Observable_js.unByKey(this._viewResolutionEventKey);
                }
                this._initialized = false;
                this._map = null;
            }
        ...
        _updateStreetViewPosition(coords) {
            ...
            let latLonGoogle;
            const isGeographic = Math.abs(coords[0]) <= 180 && Math.abs(coords[1]) <= 90;
